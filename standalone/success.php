<?php
/**
 * Success return page - customer lands here after successful payment
 */
...
<head>
    ...
    <style>
        ...
        h1 { color: #22c55e; margin: 0 0 12px; font-size: 24px; }
...
<body>
    <div class="card">
        ...
        <p>Your payment has been processed successfully. Your order is being fulfilled.</p>
        <?php if ($communityUrl): ?>
